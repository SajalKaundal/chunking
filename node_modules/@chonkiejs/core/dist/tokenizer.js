...
var Tokenizer = class Tokenizer {
	...
	*/
	static async create(model = "character") {
		if (model === "character") return new Tokenizer();
		try {
			const { HuggingFaceTokenizer } = await import("@chonkiejs/token");
			return await HuggingFaceTokenizer.create(model);
		} catch (error) {
			const errorMessage = error instanceof Error ? error.message : "";
			if (errorMessage.includes("Cannot find") || errorMessage.includes("MODULE_NOT_FOUND")) throw new Error(`
